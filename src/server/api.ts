...
// 1. PENGATURAN
apiRouter.get('/pengaturan', async (req, res) => {
...
apiRouter.post('/pengaturan', async (req, res) => {
...
// 3. PEGAWAI
apiRouter.get('/pegawai', async (req, res) => {
  const supa = await trySupabaseGet('pegawai');
  res.json(supa || db.pegawai);
});

apiRouter.post('/pegawai', async (req, res) => {
...
apiRouter.put('/pegawai/:id', async (req, res) => {
...
apiRouter.delete('/pegawai/:id', async (req, res) => {
...
// 4. HARI LIBUR
apiRouter.get('/hari-libur', async (req, res) => {
  const supa = await trySupabaseGet('hari_libur');
  res.json(supa || db.hariLibur);
});

apiRouter.post('/hari-libur', async (req, res) => {
  const item = { id: Date.now().toString(), ...req.body };
...
apiRouter.put('/hari-libur/:id', async (req, res) => {
...
apiRouter.delete('/hari-libur/:id', async (req, res) => {
...
// 5. ATASAN & PEJABAT
apiRouter.get('/atasan-pejabat', async (req, res) => {
  const supa = await trySupabaseGet('atasan_pejabat');
  res.json(supa || db.atasanPejabat);
});

apiRouter.post('/atasan-pejabat', async (req, res) => {
  const item = { id: Date.now().toString(), ...req.body };
...
apiRouter.put('/atasan-pejabat/:id', async (req, res) => {
...
apiRouter.delete('/atasan-pejabat/:id', async (req, res) => {
...
// 6. JENIS CUTI
apiRouter.get('/jenis-cuti', async (req, res) => {
  const supa = await trySupabaseGet('jenis_cuti');
  res.json(supa || db.jenisCuti);
});

apiRouter.post('/jenis-cuti', async (req, res) => {
  const item = { id: Date.now().toString(), ...req.body };
...
apiRouter.put('/jenis-cuti/:id', async (req, res) => {
...
apiRouter.delete('/jenis-cuti/:id', async (req, res) => {
...
// 7. SISA CUTI TAHUNAN
apiRouter.get('/sisa-cuti', async (req, res) => {
...
apiRouter.post('/sisa-cuti', async (req, res) => {
  const item = { id: Date.now().toString(), ...req.body };
...
apiRouter.put('/sisa-cuti/:id', async (req, res) => {
...
apiRouter.delete('/sisa-cuti/:id', async (req, res) => {
...
apiRouter.post('/sisa-cuti/generate-default', async (req, res) => {
...
apiRouter.post('/sisa-cuti/import', async (req, res) => {
...
// 8. PENGAJUAN CUTI
apiRouter.get('/pengajuan-cuti', async (req, res) => {
...
apiRouter.post('/pengajuan-cuti', async (req, res) => {
...
apiRouter.put('/pengajuan-cuti/:id', async (req, res) => {
...
apiRouter.delete('/pengajuan-cuti/:id', async (req, res) => {
  await syncFromSupabase();
...
apiRouter.get('/rekap-cuti', async (req, res) => {
